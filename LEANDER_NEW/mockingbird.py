...
def leftF(speedA):
    p.ChangeDutyCycle(speedA*(100/255))
    GPIO.output(ledpin2, False)
    GPIO.output(ledpin3, False)
    GPIO.output(ledpin4, False)
...
def rightF(speedB):
    q.ChangeDutyCycle(speedB*(100/255))
    GPIO.output(ledpin1, False)
    GPIO.output(ledpin3, False)
    GPIO.output(ledpin4, False)
...
def leftB(speedA):
    r.ChangeDutyCycle(speedA*(100/255))
    GPIO.output(ledpin1, False)
    GPIO.output(ledpin2, False)
    GPIO.output(ledpin4, False)
...
def rightB(speedB):
    s.ChangeDutyCycle(speedB*(100/255))
    GPIO.output(ledpin1, False)
    GPIO.output(ledpin2, False)
    GPIO.output(ledpin3, False)
